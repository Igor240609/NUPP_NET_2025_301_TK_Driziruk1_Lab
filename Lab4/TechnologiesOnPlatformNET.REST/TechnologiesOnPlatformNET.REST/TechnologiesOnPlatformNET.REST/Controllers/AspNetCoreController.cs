...
{
    private readonly AspNetCoreCrudService _service;

    public AspNetCoreController(AspNetCoreCrudService service)
    {
        _service = service;
    }
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] AspNetCoreModelDto dto)
    {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> Update(Guid id, [FromBody] AspNetCoreModelDto dto)
    {
